...
export class Migration1687951920821 implements MigrationInterface {
    name = 'Migration1687951920821'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" character varying NOT NULL, "password" character varying NOT NULL, "email" character varying NOT NULL, "status" character varying NOT NULL, "statusCounter" integer NOT NULL, "messageTimeCounter" integer NOT NULL, "doNotDisturb" character varying NOT NULL, "billStatus" character varying NOT NULL, "payday" character varying NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
