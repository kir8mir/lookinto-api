...
export class Migration1688234059401 implements MigrationInterface {
    name = 'Migration1688234059401'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "userword" ("id" SERIAL NOT NULL, "wordId" integer NOT NULL, "userId" character varying NOT NULL, "status" character varying NOT NULL, "progressCounter" integer NOT NULL, CONSTRAINT "PK_da4b2d12e0659ee368e152c248e" PRIMARY KEY ("id"))`);
